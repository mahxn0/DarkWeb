...
int display_param_process1(entry_buf in_buf[],int cont_value)
{
	...
	for(i=0; i<num; i++)  //待该  
	{
		...
		in_buf[8+11*i].value,in_buf[4+11*i].value,in_buf[5+11*i].value,in_buf[6+11*i].value,
		in_buf[9+11*i].value,in_buf[10+11*i].value,in_buf[7+11*i].value,in_buf[3+11*i].value,"av_stream");
		//printf("%s\n",&value[i]);
